...
parser.add_argument('--dataset', metavar='DATASET', default='cifar10', choices=['cifar10','svhn','imagenet','cifar100'],
...
parser.add_argument('--arch', default='cnn13', type=str, help='either of cnn13, WRN28_2, resnet50, WRN28_8')
...
parser.add_argument('--classwise_curriculum', action='store_true', help='applying classwise curriculum labeling')
parser.add_argument('--t_mc_dropout', type=int, default=10, help='times of mc dropout')
